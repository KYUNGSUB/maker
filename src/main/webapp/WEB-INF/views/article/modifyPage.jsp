...
<section id="wrap">
	...
	<form role="form" action="modifyPage" method="post">
		...
		<table>
			<tr>
				<td><label for="bId">번호</label>
				<td><input type="text" id="bId" name="bId" readonly="readonly" value="${articleVO.bId}">
			<tr>
				<td><label for="bTitle">제목</label>
				<td><input type="text" id="bTitle" name="bTitle" value="${articleVO.bTitle}">
			<tr>
				<td><label for="ir1">내용</label>
				<td><textarea id="ir1" rows="20" cols="132" name="bContent">${articleVO.bContent}</textarea>
			<tr>
				<td><label for="bName">작성자</label>
				<td><input type="text" name="bName" id="bName" value="${articleVO.bName}">
		</table>
